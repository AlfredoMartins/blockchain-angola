...
1. [Introduction](#introduction)
   - [What is Blockchain Angolan?](#what-is-blockchain-angola)
   - [Features](#features)
...
5. [Back-End](#back-end)
   - [Overview](#overview-2)
   - [Technologies & Frameworks](#technologies--frameworks-1)
...
Here are some of the most important endpoints provided by our REST API. For additional endpoints, refer to the [appendix](#appendix-end-points).
...
Additional endpoints are accessible in [section:committee](#sec-app-committee).
