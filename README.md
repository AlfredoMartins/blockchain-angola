...
5. [Establish Network in Data Center](#establish-network-in-data-center)
6. [Server Setup](#server-setup)
   - [Access to the System (Web)](#access-to-the-system-web)
7. [Developer Documentation](#developer-documentation)
   ...
   - [Environment Setup](#environment-setup)
     ...
     - [Set Environment Variables](#set-environment-variables)
       - [Encryption and Decryption Secrets](#encryption-and-decryption-secrets)
       - [JWT Keys Generation](#jwt-keys-generation)
   - [JWT Keys Generation](#jwt-keys-generation-1)
     - [Installation](#installation)
       - [Linux](#linux)
       - [Mac](#mac)
   - [Firebase Credentials / Storage Secrets](#firebase-credentials--storage-secrets)
   - [OpenAI Credentials](#openai-credentials)
   - [Run Development Environment](#run-development-environment)
     - [Backend](#backend)
8. [REST API Documentation](#rest-api-documentation)
   - [Base URL of the Application](#base-url-of-the-application)
   - [Routes](#routes)
     - [Endpoints](#endpoints)
       - [Blockchain Routes](#blockchain-routes)
       - [Committee Routes](#committee-routes)
   - [Error cases](#error-cases)
   - [Installation of EAS CLI](#installation-of-eas-cli)
   - [Log in to your Expo account](#log-in-to-your-expo-account)
   - [Run a build](#run-a-build)
     - [Build for app stores](#build-for-app-stores)
     - [Build APKs for Android Emulators and devices](#build-apks-for-android-emulators-and-devices)
     - [Build for iOS Simulators](#build-for-ios-simulators)
